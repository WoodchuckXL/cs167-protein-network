...
## THE BASE FOR THIS CODE IS FROM STRING'S API DOCUMENTATION AT
## https://string-db.org/cgi/help.pl?subpage=faq%23how-are-the-scores-computed
## DOWNLOAD ORIGINAL: https://stringdb-downloads.org/download/combine_subscores.v2.py
## THIS VERSION IS SPECIALIZED TO REMOVE THE DATABASE AND TEXTMINING EVIDENCE CHANNELS
## (and to play nice with how we're handling files)
##########################################################
...
"""
takes a proteins.full.xx.txt file as input and outputs a file with the proteins' 
STRING score calculated exactly as in STRING v12.0, but without the database or
text mining evidence channels.
"""
def make_fixed_file(input_file, output_file):
    ...
    for line in open(input_file):
        ...
        if header:
            header = False
            print("protein1 protein2 combined_score", file=out)
            continue
        ...
        #output to file
        print(f"{protein1} {protein2} {combined_score}", file=out)
